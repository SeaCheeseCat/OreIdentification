...
classes = ['Anorthosite', 'Aplite', 'Basalt', 'Bauxite', 'Caliche', 'Coquine', 'Dacite', 'Dolerite', 'Dolomitic_Limestone', 'Dunite', 'Essexite', 'Fossiliferous_Limestone', 'Gold', 'Granodiorite', 'Halite', 'Komatiite', 'Labradorite', 'Limestone', 'Lithium', 'Magnetite', 'Malachite', 'Mariposite', 'Mica', 'Molybdenum', 'Nickel', 'Oolitic_Limestone', 'Pegmatite', 'Phonolite', 'Phosphate', 'Potash', 'Pyrite', 'Rhyolite', 'Sandstone', 'Schists', 'Shale_(Mudstone)', 'Silica', 'Stibnite', 'Sulfur', 'Tantalum', 'Trachyte', 'Tufa', 'Tuff', 'Tungsten', 'Uranium', 'Vanadium', 'Zeolite', 'andesite', 'anthracite', 'bornite', 'breccia', 'calcite', 'chalk', 'chert', 'chromite', 'coal', 'cobalt', 'columbite-tantalite', 'copper', 'diorite', 'dolomites', 'feldspar', 'flint', 'fluorite', 'gabbro', 'gneiss', 'granite', 'gypsum', 'hornfels', 'ignimbrite', 'iron_ore', 'lapis lazuli', 'lead', '大理石', 'norite', 'novaculite', 'obsidian', 'olivine basalt', 'phyllite', 'pillow', 'platinum', 'pumice', '石英石', 'quartzite', 'serpentine', 'siltstone', 'silver', 'skarn', 'slate', 'sodalite', 'sodium_carbonate', 'syenite', 'tephrite', 'volcanic_bombs', 'zinc']
#------------------------------------------------------1.加载模型--------------------------------------------------------------
num_classes = 94
...
class picture_num(QWidget):
    ...
    def on_btn_Recognize_Clicked(self):
        ...
        print("识别结果:"+ str(txt),predicted.item() )
